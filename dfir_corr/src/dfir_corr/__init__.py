"""dfir_corr — cross-artifact correlation engine.
...
(dfir_agent) interprets; this package mechanically detects.
...
These functions are exposed to the MCP wire through dfir_mcp, which
...
def load_rules(path: Path | None = None) -> dict[str, Any]:
    ...
    The default location is dfir_corr/correlation-rules.yaml at the
