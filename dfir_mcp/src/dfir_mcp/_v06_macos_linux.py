...
Three new typed forensic functions registered on the dfir_mcp surface via @tool.
Imported by dfir_mcp/__init__.py at module load time.
...
from dfir_mcp import tool, _safe_resolve, _sha256, _parse_ts
